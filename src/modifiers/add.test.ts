...
describe('Add', function() {
  ...
  it('throws an error if either argument is undefined', function() {
    throws(() => add({} as DateObject, null as any), Error('Invalid argument'));
    throws(() => add(null as any, {}), Error('Invalid argument'));
  });
});
